...
import javax.xml.transform.Result;
    ...
    private static final String KEY_MILLIS_LEFT = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCount = findViewById(R.id.tvQuestCount);
        tvCountdown = findViewById(R.id.tvTimer);
        rbGrp = findViewById(R.id.radioGrp);
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(OuizActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    ShowNextQuestion();
                }
    ...
    private void ShowNextQuestion(){
        ...
        if (questionCounter < questionCountTotal) {
            ...
            questionCounter++;
            tvCount.setText("Question: " + questionCounter + "/" + questionCountTotal);
            answered=false;
    ...
    private void showSolution(){
        ...
        switch (currentQuestion.getAnswerNr()){
            case 1:
                ...
                tvQuest.setText("Answer 1 is correct");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                tvQuest.setText("Answer 2 is correct");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                tvQuest.setText("Answer 3 is correct");
                break;
        }
